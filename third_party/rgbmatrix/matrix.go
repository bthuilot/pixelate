...
import (
	...
	"github.com/bthuilot/pixelate/third_party/rgbemulator"
)
...
func buildMatrixEmulator(config *HardwareConfig) Matrix {
	w, h := config.geometry()
	return rgbemulator.NewEmulator(w, h, rgbemulator.DefaultPixelPitch, true)
}
...
// At return an Color which allows access to the LED agents data as
